...
const { jacCentralDiff, findRootTrustRegion, computeRho, checkTol, doglegStep, bisectionSolve, secantSolve, newtonSolve, brentSolve } = require('./root_finding.js');

const { isclose, isone, iszero, linspace, logspace, meshgrid, arange, logit, log1p, erf, erfinv, lnchoice, lnbeta, betacf, regularizedIncompleteBeta, incompleteBeta, lngamma, gammaincU, gammaincL, lnfactorial, chbevl, besseli0, clenshawCurtisWeights, clenshawCurtisIntegrate, chebPoints, cosm1 } = require('./utils_math.js');
